...
import { View, Text, Input, Icon, Button, Form, Item, Label } from 'native-base';
import { ImageBackground, Dimensions, Animated, Switch } from 'react-native';
import { PRIMARY, GREY } from '../constants/Colors';

let { width } = Dimensions.get('window'); // full width
let { height } = Dimensions.get('window'); // full height
        ...
        {!this.state.showForm && (
          <View style={loginStyles.frontScreen.container}>
            <View style={loginStyles.frontScreen.textContainer}>
              <Text style={loginStyles.frontScreen.title}>{applyLetterSpacing('AGSPINE')}</Text>
              <View style={loginStyles.frontScreen.body.container}>
                <Text style={loginStyles.frontScreen.body.text}>
                  Digitalise and streamline your agriculture business
                </Text>
              </View>
            </View>
            <View style={loginStyles.frontScreen.buttonContainer}>
              <Button
                style={loginStyles.frontScreen.registerButton}
                full
                onPress={this.showForm('sign-up')}
              >
                <Text style={loginStyles.frontScreen.registerText}>Sign Up</Text>
              </Button>
              <Button
                style={loginStyles.frontScreen.loginButton}
                full
                onPress={this.showForm('log-in')}
              >
          ...
          <View style={loginStyles.horizontal}>
              ...
              <Text
                style={
                  this.state.type === 'sign-up'
                    ? loginStyles.toggle.activeText
                    : loginStyles.toggle.inactiveText
                }
              >
                Sign Up
              </Text>
            ...
            <Form>
              ...
              <Button
                ...
                full
                onPress={this.state.type === 'sign-up' ? this.handleSignup : this.handleLogin}
              >
                <Text style={loginStyles.primaryText}>
                  {this.state.type === 'sign-up' ? 'Sign' : 'Log'} In
                </Text>
              </Button>
              <Button iconLeft bordered style={loginStyles.outlineButton} full>
                ...
                <Text style={loginStyles.outlineButtonText}>
                  {this.state.type === 'sign-up' ? 'Sign' : 'Log'} In With google
                </Text>
              </Button>
